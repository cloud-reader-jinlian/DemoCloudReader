package com.eidlink.bluetooth.activity.base;
...
public abstract class BaseActivity extends Activity implements EasyPermissions.PermissionCallbacks {
    ...
    protected void requestPermissions() {
        String[] perms = {Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.ACCESS_COARSE_LOCATION,Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.READ_PHONE_STATE};
